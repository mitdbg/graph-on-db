...
public class SGDWithCollabFiltering2 extends Vertex<IntWritable, Text, DoubleWritable, Text>{
	...
	/** Logger */
	private static final Logger LOG = Logger.getLogger(SGDWithCollabFiltering2.class);
